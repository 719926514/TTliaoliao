...
public class GlideImgManager {
    ...
    public static void load(Context context, String url, int emptyImg, ImageView iv, GlideType
            type) {
    ...
    public static void load(Context context, String url, ImageView iv, GlideType type, int
            roundDp) {
    ...
    public static void loadFile(Context context, String path, int erroImg, int emptyImg,
                                ImageView iv) {
        loadFile(context, new File(path), erroImg, emptyImg, iv, null, 0);
    }

    public static void loadFile(Context context, String path, int erroImg, int emptyImg,
                                ImageView iv, GlideType type) {
    ...
    public static void loadFile(Context context, File file, int erroImg, int emptyImg, ImageView
            iv, GlideType type, int roundDp) {
    ...
    public static void loadCircleByBitmap(final Context context, String url, final ImageView
            imageView, int emptyImageRes) {
     ...
     * @param imageView
     */
    public static void loadRoundByBitmap(final Context context, String url, final ImageView
            imageView) {
     ...
     * @param url
     * @param imageView
     * @param scaleType 图片缩放类型 scaleType=1 fitCenter  scaleType=2 centerCrop scaleType=3 fitXY
     *                  scaleType=4 centerInside
     * @author ailibin
     */
    @SuppressLint("NewApi")
    public static void loadRoundByBitmap(final Context context, String url, final ImageView
            imageView, int emptyImageRes, final int roundDp, final int scaleType) {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
    public static void loadImgToBackground(Context context, String url, int emptyView, final View
            view) {
     ...
     * @author ailibin
     */
    public static void LoadImgToBackground(Context context, String url, final View view, int
            width, int height) {
