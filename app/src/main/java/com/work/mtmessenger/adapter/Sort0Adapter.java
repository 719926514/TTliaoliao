 ...
 * @date: 2017/7/19
 */
public class Sort0Adapter extends SlideRecyclerViewBaseAdapter {
    ...
    public Sort0Adapter(Context context, List<SortModel> data, CallBack callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item0, parent, false);
