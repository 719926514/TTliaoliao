...
public class MessgListViewAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private Activity context;
    private List<Lgin.DataBean.FriendUnreadArrayBean> list;


    public MessgListViewAdapter(Activity context, int resource, List<Lgin.DataBean.FriendUnreadArrayBean> list) {
        super();
    ...
    public List<Lgin.DataBean.FriendUnreadArrayBean> getList() {
        return list;
    }

    public void setList(List<Lgin.DataBean.FriendUnreadArrayBean> list) {
        this.list = list;
    }
